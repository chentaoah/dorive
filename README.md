...
​		dorive是一个轻量的以领域驱动为核心的业务框架，它提供了诸多开箱即用的功能，旨在帮助开发者快速、便捷地在项目中应用领域驱动，并从中受益。
...
​		dorive是Mybatis-Plus的拓展，易于集成，开发者无需添加任何配置和代码。
...
| 3.x-3.4.3.4 | 重新设计内部架构，并优化大量代码。自3.4.3.4版本开始，项目进入维护阶段。 |
...
| 3.x    | 版本分支，分支名即版本号，版本号高于master的，即为正在开发的分支。 |

### 🔗依赖说明

| 依赖库                    | 版本            | 说明                 |
| ------------------------- | --------------- | -------------------- |
| spring-boot-starter-web   | 2.7.8（可降级） | spring-boot的web集成 |
| spring-tx                 | 5.3.9           | spring事务管理       |
| hutool-all                | 5.8.12          | 工具库               |
| javassist                 | 3.29.2-GA       | 动态代理实现         |
