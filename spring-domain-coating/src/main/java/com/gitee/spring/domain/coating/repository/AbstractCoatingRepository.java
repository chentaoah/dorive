...
public abstract class AbstractCoatingRepository<E, PK> extends AbstractEventRepository<E, PK> {
    ...
    protected void resolveCoatingAssemblers(String... basePackages) throws Exception {
        for (String basePackage : basePackages) {
            ...
            for (Class<?> coatingClass : classes) {
                ...
                Map<String, PropertyDefinition> belongPropertyDefinitions = new LinkedHashMap<>();
                ...
                ReflectionUtils.doWithLocalFields(coatingClass, declaredField -> {
                    ...
                    PropertyDefinition propertyDefinition = new PropertyDefinition(declaredField, fieldClass, isCollection, genericFieldClass, fieldName,
                            attributes, belongAttribute, aliasAttribute, isBound, entityPropertyChain);
                    ...
                    if (isBound) {
                        belongPropertyDefinitions.put(belongAttribute, propertyDefinition);
                    } else {
                        fieldPropertyDefinitions.put(fieldName, propertyDefinition);
                    }
                });

                List<RepositoryLocation> repositoryLocations = collectRepositoryLocations(belongPropertyDefinitions, fieldPropertyDefinitions);
    ...
    protected List<RepositoryLocation> collectRepositoryLocations(Map<String, PropertyDefinition> belongPropertyDefinitions,
                                                                  Map<String, PropertyDefinition> fieldPropertyDefinitions) {
        List<RepositoryLocation> repositoryLocations = new ArrayList<>();
        collectRepositoryLocations(repositoryLocations, new ArrayList<>(), null, this, belongPropertyDefinitions, fieldPropertyDefinitions);
    ...
    protected void collectRepositoryLocations(List<RepositoryLocation> repositoryLocations,
                                              ...
                                              Map<String, PropertyDefinition> belongPropertyDefinitions,
                                              Map<String, PropertyDefinition> fieldPropertyDefinitions) {
        ...
        if (belongPropertyDefinitions.containsKey(rootAccessPath)) {
            ...
            PropertyDefinition propertyDefinition = belongPropertyDefinitions.get(rootAccessPath);
        ...
        for (EntityPropertyChain entityPropertyChain : entityPropertyChainMap.values()) {
            ...
            if (configuredRepository != null) {
                ...
                if (belongPropertyDefinitions.containsKey(absoluteAccessPath)) {
                    PropertyDefinition propertyDefinition = belongPropertyDefinitions.get(absoluteAccessPath);
        ...
        for (ConfiguredRepository configuredRepository : delegateConfiguredRepositories) {
            ...
            collectRepositoryLocations(repositoryLocations, multiAccessPath, configuredRepository, delegateRepository, belongPropertyDefinitions, fieldPropertyDefinitions);
        }
    }
