...
import com.gitee.dorive.mybatis.v1.impl.querier.DefaultCountQuerier;
import com.gitee.dorive.mybatis.v1.impl.segment.DefaultSegmentExecutor;
import com.gitee.dorive.mybatis.v1.impl.segment.DefaultSegmentResolver;
import com.gitee.dorive.query.v1.api.QueryResolver;
import com.gitee.dorive.query.v1.api.SegmentExecutor;
import com.gitee.dorive.query.v1.api.SegmentResolver;
import com.gitee.dorive.query.v1.impl.core.QueryConfigResolver;
import com.gitee.dorive.query.v1.impl.core.RepositoryNodeResolver;
import com.gitee.dorive.query.v1.impl.custom.CustomQueryExecutor;
import com.gitee.dorive.query.v1.impl.fallback.ContextMismatchQueryExecutor;
import com.gitee.dorive.query.v1.impl.segment.RepositoryJoinResolver;
import com.gitee.dorive.query.v1.impl.segment.SegmentQueryExecutor;
import com.gitee.dorive.query.v1.impl.segment.SegmentQueryResolver;
import com.gitee.dorive.query.v1.impl.stepwise.StepwiseQuerier;
import com.gitee.dorive.query.v1.impl.stepwise.StepwiseQueryExecutor;
import com.gitee.dorive.query.v1.impl.stepwise.StepwiseQueryResolver;
...
public class DefaultRepositoryBuilder implements RepositoryBuilder {
    ...
    public void buildQueryExecutor4(RepositoryContext repositoryContext) {
        ...
        if (repositoryContext instanceof AbstractMybatisRepository) {
            ...
            // 查询执行器
            QueryExecutor queryExecutor = new CustomQueryExecutor(queryConfigResolver, primaryKey, entityStoreInfo, (AbstractRepository<Object, Object>) repository);
