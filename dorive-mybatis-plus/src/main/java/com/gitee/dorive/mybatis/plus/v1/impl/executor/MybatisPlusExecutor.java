...
package com.gitee.dorive.mybatis.plus.v1.impl.executor;
...
import com.gitee.dorive.mybatis.plus.v1.api.EasyBaseMapper;
...
public class MybatisPlusExecutor extends AbstractExecutor {
    ...
    public Result<Object> executeQuery(Context context, Query query) {
        ...
        if (example != null) {
            ...
            com.gitee.dorive.base.v1.executor.entity.qry.Page<Object> page = example.getPage();
            if (page != null) {
