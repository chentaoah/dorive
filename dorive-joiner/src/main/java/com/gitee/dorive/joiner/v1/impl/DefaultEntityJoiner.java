...
public class DefaultEntityJoiner extends HashMapEntityJoiner {

    protected final EntityElement entityElement;

    public DefaultEntityJoiner(boolean collection, EntityElement entityElement, List<Object> entities) {
